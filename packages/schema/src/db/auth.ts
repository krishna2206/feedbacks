/**
 * Better Auth tables (user, session, account, verification, organization, team,
 * team_member, member, invitation). Generated with `pnpm dlx auth generate` from the
 * API's auth config — regenerate when auth plugins change. Do not edit by hand.
 */
...
export const team = pgTable(
  "team",
  {
    ...
    createdAt: timestampTz("created_at").notNull(),
    updatedAt: timestampTz("updated_at").$onUpdate(() => /* @__PURE__ */ new Date()),
  },
